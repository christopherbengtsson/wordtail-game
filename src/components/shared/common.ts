...
export const commonBoxShadow = '4px 4px 10px 0 rgba(0, 0, 0, 0.35)';
...
type BorderStyle = {
  topLeftOuter: keyof IColors;
  topLeftInner: keyof IColors | null;
  bottomRightInner: keyof IColors | null;
  bottomRightOuter: keyof IColors;
};
...
export const createInnerBorderWithShadow = ({
  ...
  [
    hasShadow ? commonBoxShadow : false,
  ...
  ::-webkit-scrollbar-track {
    ${({ theme }) =>
      createHatchedBackground({
        ...
        secondaryColor:
          variant === 'flat' ? theme.canvas : theme.borderLightest,
      })}
  }
